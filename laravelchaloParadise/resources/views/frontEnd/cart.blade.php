                    ...
                    <tbody>
                        @foreach($cart_datas as $cart_data)
                            ...
                            <tr>
                                ...
                                <td class="cart_total">
                                    <p class="cart_total_price">{{$cart_data->price*$cart_data->quantity}} DH</p>
                                </td>
                    ...
                    <div class="total_area">
                        <ul>
                            @if(Session::has('discount_amount_price'))
                                <li> Sous-total <span> {{$total_price}} DH</span></li>
                                <li>Réduction (Code : {{Session::get('coupon_code')}}) <span> {{Session::get('discount_amount_price')}} DH</span></li>
                                <li>Total <span> {{$total_price-Session::get('discount_amount_price')}} DH</span></li>
                            @else
                                <li>Totale <span> {{$total_price}} DH</span></li>
                            @endif
                        </ul>
                        <div style="margin-left: 20px;"><a class="btn btn-default check_out" href="{{url('/check-out')}}">Valider Commande</a></div>
                    </div>
                </div>
            </div>
        </div>
