		...
		<div class="col-md-9">
	        ...
	        <form action="{{url ('/contact') }}" method="post">
	          ...
	          <div class="form-group">               
	            <input style="border-bottom-color: orange; border-radius:10px;" type="text"  value="{{old('name')}}" placeholder="Votre Nom" class="form-control" name="name" >
	            <div>{{$errors->first('name')}}</div>              
	          </div>

	          <div class="form-group">               
	            <input style="border-bottom-color: orange; border-radius:10px;" type="text" value="{{old('email')}}" placeholder="Votre Email" class="form-control" name="email" >
	          ...
	          <div class="form-group"> 
	            <textarea style="border-bottom-color: orange; border-radius:10px;" class="form-control"  rows="5"  placeholder="Votre Message" class="form-control" name="message" >{{old('message')}}</textarea>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="info"><i style="width: 55px" class=" fa fa-mobile"></i>
              <div style="margin-left: 15px" class="txt"><span class="txt1">05 22 97 65 42</span>  <span class="txt2">Allo ChaloPardis</span></div>
            </div>
          </div><br>
          <div class="row">
            <div class="info"><i class=" fa fa-envelope"></i>
              <div class="txt"><span class="txt1">contact@chaloParadis.ma</span> <span class="txt2">Contactez-nous par e-mail</span></div>
            </div>
          </div><br>
        </div>
      </div>
