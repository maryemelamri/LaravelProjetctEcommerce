...
/* STRUCTURE */
.card-body{padding: 0;margin:10px;}
.wrapper {
  display: flex;
  align-items: center;
         ...
         <div class="card">
           <article class="card-body mx-auto" style="max-width: 470px;">
                ...
                <div class="fadeIn first">
                  <img src="{{asset('frontEnd/images/home/logo.png')}}" id="icon" alt="User Icon" />
                </div>
                <br>
                ...
                <form id="loginform" class="form-vertical" method="POST" action="{{ route('login') }}">
                  ...
                  <!-- <input type="text" id="login" class="" name="login" placeholder="Nom d'utilisateur"> -->
