                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                                        ...
                                        <table class="table table-condensed total-result">
                                            ...
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    <td>Réduction</td>
                                                    <td> {{Session::get('discount_amount_price')}} DH</td>
                                                </tr>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span> {{$total_price-Session::get('discount_amount_price')}} DH</span></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>Totale</td>
                                                    <td><span> {{$total_price}} DH</span></td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
                        ...
                        <div class="payment-options">
                            <span>Sélectionner  méthode de Paiement : </span>
                        <span>
                            ...
                            <button type="submit" class="btn btn-primary" style="float: right;">Valider la Commande</button>
                        </div>
                    </section>
