...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Produit</a> <a href="{{route('product.create')}}" class="current">Ajout d'un Produit</a> </div>
            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <label class="control-label">selectionner Categorie</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="p_color" class="control-label">Coleurr</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('price')?' has-error':''}}">
                            <div class="input-prepend"> 
                                ...
                                <span class="add-on">DH</span><span class="text-danger">{{$errors->first('price')}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
