            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                    ...
                    <tr>
                        ...
                        <th>Coleur de Produit</th>
                        <th>Prix</th>
                        <th>les Images de produits</th>
                        <th>les attributs</th>
                        <th>Action</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('image-gallery.show',$product->id)}}" class="btn btn-default btn-mini">Ajouter img</a></td>
